...
- (void)viewDidLoad {
    ...
    UIButton *previousButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4 - 50, 25, 50, 50)];
    ...
    UIButton *nextButton = [[UIButton alloc] initWithFrame:CGRectMake(3*SCREEN_WIDTH/4, 25, 50, 50)];
